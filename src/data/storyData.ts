...
export const ALL_COLLECTIBLE_LIGHTS: Record<string, LightItem> = {
  ...
  sww_pin: {
    ...
    description: {
      ...
      fr: 'Une broche précieuse en émail doré offerte par le Clown Mélo en hommage à Super Sorcière Wendy.',
    },
    color: '#fbbf24',
...
export const STORY_DATA: Record<string, DialogueLine> = {
    ...
    choices: [
      ...
      },
      {
        ...
        text: {
          ...
          fr: 'Laisser Lezar s’avancer pour poser ses pattes tièdes sur la mousse et diffuser ensemble la douce braise.',
        },
  ...
  chapter1_res1: {
    ...
    text: {
      ...
      fr: 'Une lumière dorée ruisselle de ses doigts jusqu’à la terre. Le givre fond en rosée claire, et de fraîches pousses émeraude se déploient avec un frémissement ravi.',
    },
    ...
    choices: [
      {
        ...
        text: {
          ...
          fr: 'Puiser dans votre lanterne pour déposer une douce braise dorée au cœur de son four de pierre.',
        },
  ...
  chapter5_1b: {
    ...
    text: {
      ...
      fr: 'La fiole brilla d’une clarté éblouissante, illuminant l’immensité abyssale… puis, avec un tintement cristallin, la lumière s’éteignit dans un silence d’encre.',
    },
  ...
  chapter6_choice: {
    ...
    zoom: 'normal',
    text: {
      en: 'Wendy took a deep, steady breath, raising her wooden wand and looking out toward the dark horizon with quiet resolve. It was time.',
      fr: 'Wendy prit une profonde inspiration, levant sa baguette de bois et regardant vers l’horizon obscur avec une douce détermination. L’heure était venue.',
    },
    choices: [
      {
        id: 'sea_release_sun_wand',
        text: {
          en: 'Wave your wand in a graceful arc to open the lantern and lift the Sun to the sky! 🪄✨🌅',
          fr: 'Agiter votre baguette en un arc gracieux pour ouvrir la lanterne et élever le Soleil vers le ciel ! 🪄✨🌅',
        },
        nextSceneId: 'chapter7_1',
      },
      {
        id: 'sea_release_sun_whisper',
        text: {
          en: 'Channel your heartfelt magic and gently whisper to the morning light: “Go home, dawn.” ☀️💖🌊',
          fr: 'Canaliser votre magie bienveillante et murmurer doucement à la lumière de l’aube : « Rentre chez toi. » ☀️💖🌊',
        },
        nextSceneId: 'chapter7_1',
      },
    ],
  ...
  chapter8_3c: {
    ...
    sfx: 'clown_musical',
    text: {
      en: 'He blinked under the golden sunlight, adjusting his monocle and dusting off his velvet lapels. With a grand theatrical bow, he tipped his top hat to Wendy. “Well, well! It seems the morning light suits us far better than the dreary dark, wouldn’t you agree?” 🎩✨',
      fr: 'Il cligna des yeux sous la lumière dorée, ajusta son monocle et épousseta ses revers de velours. Avec une théâtrale révérence, il ôta son haut-de-forme devant Wendy. « Eh bien, eh bien ! Il semblerait que la lumière matinale nous siée bien mieux que l’obscurité maussade, n’est-ce pas ? » 🎩✨',
    },
  ...
  chapter8_4: {
    ...
    sfx: 'magical_chime',
    text: {
      en: 'Mélo Clown stepped forward with an elegant theatrical flourish. In his gloved hands, he revealed a cuddly golden-yellow bear plush named GBear in a tiny red vest, holding a warm glowing starlight spark. “You seem to be missing something.” 🧸✨',
      fr: 'Le Clown Mélo s’avança avec une élégante révérence théâtrale. Entre ses mains gantées, il dévoila une douce peluche d’ours jaune doré nommée GBear vêtue d’un petit gilet rouge, tenant une étincelle stellaire chaleureuse. « Il semblerait qu’il vous manque quelque chose. » 🧸✨',
    },
  ...
  chapter8_5: {
    ...
    zoom: 'close_up',
    text: {
      en: '“What’s this…?” she asked softly, her eyes glistening and a warm golden glow washing over her at the sight of the adorable little bear.',
      fr: '« Qu’est-ce que… ? » murmura-t-elle doucement, ses yeux brillant et une douce lueur dorée l’enveloppant à la vue du charmant petit ourson.',
    },
  ...
  chapter8_6: {
    ...
    sfx: 'magical_chime',
    text: {
      en: 'He gently nestled the radiant spark into Wendy’s hands alongside GBear, smiling with sincere tenderness. “Your share… and a loyal, cozy friend so you never feel alone again.” 🧸💛✨',
      fr: 'Il déposa délicatement l’étincelle radieuse dans les mains de Wendy aux côtés de GBear, souriant avec une infinie tendresse. « Votre part… et un compagnon tout doux et fidèle pour que vous ne vous sentiez plus jamais seule. » 🧸💛✨',
    },
  ...
  chapter8_7: {
    ...
    sfx: 'magical_chime',
    text: {
      en: 'Wendy hugged GBear against her chest, feeling its magical honey-gold warmth and the shared light radiate through her soul. She understood the truth: she never needed to carry the sun alone. Light is something we keep alive together. 🧸💛✨',
      fr: 'Wendy serra GBear contre son cœur, sentant sa chaleur magique miel et or et la lumière partagée rayonner dans son âme. Elle comprit la vérité : elle n’avait jamais eu besoin de porter le soleil toute seule. La lumière est ce que nous maintenons vivant ensemble. 🧸💛✨',
    },
  ...
  epilogue_12: {
    ...
    text: {
      ...
      fr: 'Orik le Follet sautilla d’excitation sur la table près d’un bol de fraises sucrées ! « Wendy ! Nous voulions te rendre la pareille ! Tu as réchauffé nos racines gelées quand nous n’avions plus rien. Regarde ! J’ai apporté des baies sauvages et des guirlandes de fleurs ! »',
    },
  ...
  epilogue_19: {
    ...
    location: 'birthday_feast',
    text: {
      en: 'Wendy looked at Lezar purring beside her, Mélo Clown holding the glowing cake, GBear waving warmly in the background, Orik waving his leafy arms, Vivienne smiling warmly, and sweet Hypo hugging her soft neck pillow. She smiled softly. “I don’t need to wish for anything… my wish is already standing right here with me.”',
      fr: 'Wendy regarda Lezar ronronner près d’elle, le Clown Mélo portant le gâteau illuminé, GBear agitant joyeusement la patte à l’arrière-plan, Orik agitant ses bras feuillus, Vivienne souriant chaleureusement et la douce Hypo serrant son coussin de cou. Elle sourit doucement. « Je n’ai besoin de rien souhaiter… mon vœu le plus cher est déjà réuni ici avec moi. »',
    },
